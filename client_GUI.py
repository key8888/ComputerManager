...
class DynamicButtonApp:
    ...
    def create_widgets(self):
        ...
        update_button = ttk.Button(control_frame, text="更新", command=self.update_buttons)
        ...
        self.button_frame.pack(expand=True, fill=tk.BOTH, padx=10, pady=5) # 外側のパディング
    ...
    def on_button_click(self, button_id, button_widget):
        ...
        timer_id = self.master.after(5000, lambda: self.reset_button_text(button_widget, original_text))
    ...
    def update_buttons(self, event=None):
        ...
        try:
            ...
            messagebox.showerror("入力エラー", "有効な整数を入力してください。", parent=self.master)
        ...
        for i in range(new_count):
            ...
            button.config(command=lambda id=i+1, btn=button: self.on_button_click(id, btn))
